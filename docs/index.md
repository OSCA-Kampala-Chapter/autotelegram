...
Autotelegram is a python telegram bot library targetted to help you build telegram bots with simplicity
and ease of use in mind. The project is under active development and still in beta stages.
...
## **Sponsorships**
Autotelegram is built by developers from the open source community of kampala and various other contributors. To support this project and other incubator projects in OSC-Kampala, please consider sponsoring.
#### **How to sponsor**
...
| :---        |    :----:   |          ---: |
| certifi     | 2022.9.24   | it identifies the holder and provides other important information. [installation-guide-here](https://pypi.org/project/certifi/) |
| charset-normalizer     | 2.1.1       | A library that helps you read text from an unknown charset encoding. [installation-guide-here](https://pypi.org/project/charset-normalizer/2.1.1/) |
| click  | 8.1.3 | package for creating beautiful command line interfaces in a composable way with as ittle code as necessary. It’s the “Command Line Interface Creation Kit”. [installation-guide-here](https://pypi.org/project/click/)|
| ghp-import | 2.1.0  | The ghp-import output command updates the local gh-pages branch with the content of the output directory (creating the branch if it doesn't already exist). [installation-guide-here](https://pypi.org/project/ghp-import/)|
| griffe | 0.23.0 | Signatures for entire Python programs. Extract the structure, the frame, the skeleton of your project, to generate API documentation. [installation-guide-here](https://pypi.org/project/griffe/0.23.0/) |
| idna | 3.4 | Support for the Internationalized Domain Names in Applications (IDNA) protocol as specified in RFC 5891. This is the latest version of the protocol and is sometimes referred to as “IDNA 2008”.[installation-guide-here](https://pypi.org/project/idna/) |
| importlib-metadata | 5.0.0 | Library to access the metadata for a Python package. This package supplies third-party access to the functionality of importlib.metadata including improvements added to subsequent Python version. [installation-guide-here](https://pypi.org/project/importlib-metadata/)|
| Jinja2 | 3.1.2 | Jinja is a fast, expressive, extensible templating engine. Special placeholders in the template allow writing code similar to Python syntax. Then the template is passed data to render the final document. [installation-guide-here](https://pypi.org/project/Jinja2/) |
| Markdown| 3.3.7 | This is a Python implementation of John Gruber's Markdown. It is almost completely compliant with the reference implementation, though there are a few known issues. [installation-guide-here](https://pypi.org/project/Markdown/3.3.7/) | 
| MarkupSafe | 2.1.1 | MarkupSafe implements a text object that escapes characters so it is safe to use in HTML and XML. Characters that have special meanings are replaced so that they display as the actual characters. [installation-guide-here](https://pypi.org/project/MarkupSafe/) |
| mergedeep | 1.3.4 | A deep merge function for 🐍. [installation-guide-here](https://pypi.org/project/mergedeep/) |
| mkdocs | 0.4.1 | MkDocs is a fast, simple and downright gorgeous static site generator that's geared towards building project documentation. Documentation source files are written in Markdown, and configured with a single YAML configuration file. [installation-guide-here](https://pypi.org/project/mkdocs/) |
| mkdocs-autorefs | 0.4.1 | Automatically link across pages in MkDocs. [installation-guide-here](https://pypi.org/project/mkdocs-autorefs/) |
