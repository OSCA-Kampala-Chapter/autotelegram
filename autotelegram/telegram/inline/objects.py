...
from autotelegram.telegram.objects import BaseObject
from typing import Optional, TYPE_CHECKING

if TYPE_CHECKING:
    from autotelegram.telegram.objects import User, Location, MessageEntity, InlineKeyboardMarkup
    from autotelegram.telegram.payments.objects import LabeledPrice
...
class InputTextMessageContent(InputMessageContent):
    ...
    Args:
        ...
        entities (List[:class:`autotelegram.telegram.objects.MessageEntity`], optional): List of special entities that appear in message text, 
        ...
        reply_markup (:class:`autotelegram.telegram.objects.InlineKeyboardMarkup`, optional): Additional interface options. 
...
class InputInvoiceMessageContent(InputMessageContent):
    ...
    Args:
        ...
        prices (List[:class:`autotelegram.telegram.objects.LabeledPrice`]): Price breakdown, a list of components (e.g. product price, tax, discount, delivery cost, delivery tax, bonus, etc.)
