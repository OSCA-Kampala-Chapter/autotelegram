...
if TYPE_CHECKING:
    ...
    from autotelegram.telegram.objects.message import Message
    from autotelegram.telegram.objects.poll import Poll, PollAnswer
    from autotelegram.telegram.objects.chatmember import ChatMemberUpdated
    from autotelegram.telegram.objects.chat import ChatJoinRequest
    from autotelegram.telegram.objects.callbackquery import CallBackQuery
    from autotelegram.telegram.payments.objects import ShippingQuery, PreCheckoutQuery
    from autotelegram.telegram.inline.objects import InlineQuery, ChosenInlineResult
